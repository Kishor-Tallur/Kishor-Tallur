...
<img src="https://komarev.com/ghpvc/?username=Kishor-Tallur&label=Profile%20Views&color=0e75b6&style=flat" />
...
I'm an **Information Science & Engineering graduate** from **Canara Engineering College**, passionate about building technology that solves real-world problems.
...
- 🏆 Hackathon Winner
- 🥇 Top 50 National Rank — **XYPHERIA 2026**
- 👥 Chief Coordinator — **Mangaluru Technovanza 2025**
- 🧬 Interested in **Medical AI & Computer Vision**
- 💡 Passionate about transforming ideas into practical products
...
## 🩺 Medical Diagnostic Tool for Retinal Vein Occlusion

An AI-based medical imaging project focused on the analysis of **Retinal Vein Occlusion (RVO)**.
...
I worked on **technical documentation, model optimization, analytical problem solving, and translating complex technical outputs into interpretable information**.

> Building AI systems isn't only about model accuracy — it's about making complex technical results understandable and useful.
...
## 🌟 Student Entrepreneur & Keynote Speaker

I've had opportunities to address university student cohorts from **1st to 3rd year** on topics surrounding:
...
> **Make complex ideas understandable, actionable and inspiring.**
...
A major technology summit hosted by **KDEM**.

### Responsibilities

- 👥 Coordinated volunteer teams
- 🤝 Managed stakeholder communication
- 📋 Worked with organizers and delegates
- ⚙️ Managed event logistics
